 ...
 *  * Build: http://modernizr.com/download/#-shiv-load-cssclasses-opacity-svg-input-touch-json-audio-canvas-video-mq
 *   */
;
window.Modernizr = function(e, t, n) {
        ...
        function A() {
            i.input = function(n) {
                for (var r = 0, i = n.length; r < i; r++) m[n[r]] = n[r] in l;
        ...
        var r = "2.8.3",
            ...
            E = function(t) {
                ...
                var r;
                return w("@media " + t + " { #" + u + " { position: absolute; } }", function(t) {
        ...
        !C(S, "undefined") && !C(S.call, "undefined") ? x = function(e, t) {
            ...
            var r = y.call(arguments, 1),
                i = function() {
                    if (this instanceof i) {
                        ...
                        var s = new e,
                            o = n.apply(s, r.concat(y.call(arguments)));
            ...
            var n;
            return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : w(["@media (", h.join("touch-enabled),("), u, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
                n = e.offsetTop === 9
            }), n
        }, d.opacity = function() {
        ...
        for (var O in d) x(d, O) && (b = O.toLowerCase(), i[b] = d[O](), g.push((i[b] ? "" : "no-") + b));
        return i.input || A(), i.addTest = function(e, t) {
                if (typeof e == "object")
            ...
            function(e, t) {
                ...
                e.html5 = y, g(t)
            }(this, t), i._version = r, i._prefixes = h, i.mq = E, i.testStyles = w, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + g.join(" ") : ""), i
    }(this, this.document),
    function(e, t, n) {
        function r(e) {
